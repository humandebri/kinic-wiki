...
run("open", [`${baseUrl}/missing-route`]);
assertSnapshotIncludes("Page not found");
assertSnapshotIncludes("Open start page");

run("open", [`${baseUrl}/site/${encodeURIComponent(canisterId)}/Wiki/does-not-exist.md`]);
